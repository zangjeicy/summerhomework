...
<p align="center">
  <img src="assets/readme_workspace_tour_20260510.gif" alt="金股睿析 Web 工作台演示" width="720">
</p>
...
> 金股睿析聚焦日常分析報告；以下兩個同系列項目分別覆蓋選股、策略驗證與策略進化，適合按需延伸使用。它們目前獨立維護，後續會優先探索與金股睿析的候選股導入、回測驗證和報告聯動。
