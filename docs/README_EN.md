...
<p align="center">
  <img src="assets/readme_workspace_tour_20260510.gif" alt="JinguRuiXi Web workspace demo" width="720">
</p>
...
> JinguRuiXi focuses on daily analysis reports. These sibling projects cover stock screening, strategy validation, and strategy evolution for users who want to extend the workflow. They are maintained independently today, with candidate import, backtest validation, and report handoff planned as future integration directions.
