...
[![GitHub stars](https://img.shields.io/github/stars/zangjeicy/JinguRuiXi?style=social)](https://github.com/zangjeicy/JinguRuiXi/stargazers)
[![CI](https://github.com/zangjeicy/JinguRuiXi/actions/workflows/ci.yml/badge.svg)](https://github.com/zangjeicy/JinguRuiXi/actions/workflows/ci.yml)
...
<p align="center">
  <img src="docs/assets/readme_workspace_tour_20260510.gif" alt="金股睿析 Web 工作台演示" width="720">
</p>
...
```bash
# 克隆项目
git clone https://github.com/zangjeicy/JinguRuiXi.git && cd JinguRuiXi
...
> 金股睿析聚焦日常分析报告；下面两个同系列项目分别覆盖选股、策略验证与策略进化，适合按需延伸使用。它们当前独立维护，后续会优先探索与金股睿析的候选股导入、回测验证和报告联动。
...
- 金股睿析源码：https://github.com/zangjeicy/JinguRuiXi
- 问题反馈：https://github.com/zangjeicy/JinguRuiXi/issues
- 官方下载与更新：当前尚未配置经确认的稳定 Release 仓库，桌面端自动更新默认关闭。

金股睿析基于 [ZhuLinsen/daily_stock_analysis](https://github.com/ZhuLinsen/daily_stock_analysis) 二次开发，感谢上游作者与贡献者。上游仓库仅用于来源致谢，不是金股睿析的发布、下载、更新或反馈渠道。产品 SemVer、课程版本与不可变的 v0.1.0 教学 ZIP 各自独立。

## 📄 License

[MIT License](LICENSE) © 2026 张峻诚
