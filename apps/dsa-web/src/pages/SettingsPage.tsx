...
const FirstRunSetupCard: React.FC<FirstRunSetupCardProps> = ({
  ...
  if (isHidden) {
    return (
      <div className="surface-card settings-border px-4 py-3">
  ...
  return (
    ...
    >
      <div data-testid="first-run-setup-card" className="space-y-4">
        <div className="surface-inset settings-border flex flex-col gap-3 px-4 py-4 md:flex-row md:items-start md:justify-between">
        ...
        {status ? (
          <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
            {status.checks.map((check) => (
              <div
                key={check.key}
                className="surface-inset settings-border px-4 py-3"
              >
    ...
    >
      <div data-testid="scheduler-settings-card" className="space-y-4">
        <div className="grid grid-cols-1 gap-3 lg:grid-cols-[minmax(0,1fr)_minmax(300px,360px)]">
          <div className="surface-inset settings-border space-y-4 px-4 py-4">
          ...
          <div className="surface-inset settings-border space-y-3 px-4 py-4">
            <div>
            ...
            <dl className="grid grid-cols-1 gap-2 text-xs">
              <div className="surface-inset settings-border px-3 py-2">
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-[260px_minmax(0,1fr)]">
          ...
          <section className="space-y-4">
            ...
            {shouldShowAlphaSiftSettings ? (
              ...
              >
                <div className="surface-inset settings-border flex flex-col gap-4 px-4 py-4 md:flex-row md:items-center md:justify-between">
                  <div>
                    <p className="text-sm font-semibold text-foreground">
            ...
            {activeCategory === 'system' ? (
              ...
              >
                ...
                {canCheckDesktopUpdate ? (
                  <div className="surface-inset settings-border mt-4 space-y-3 px-4 py-4">
                    <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                      <div>
