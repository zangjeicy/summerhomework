...
const HomePage: React.FC = () => {
  ...
  return (
    ...
    >
      <div data-testid="home-workspace" className="flex h-full min-h-0 min-w-0 w-full flex-1 flex-col">
        <header data-testid="home-dashboard-header" className="relative z-30 flex min-w-0 shrink-0 items-center overflow-visible px-3 py-3 md:px-4 md:py-4 lg:h-16 lg:py-0">
        ...
        <div className="flex-1 flex min-h-0 overflow-hidden">
          <div data-testid="home-dashboard-sidebar" className="hidden min-h-0 w-64 shrink-0 flex-col overflow-hidden pl-4 pb-4 md:flex lg:w-72">
            {sidebarContent}
          </div>
          ...
          <section
            ...
            className="flex-1 min-w-0 min-h-0 overflow-x-hidden overflow-y-auto px-3 pb-4 md:px-6 touch-pan-y"
          >
            {marketReviewNotice ? (
              <div className="mb-3">
                <InlineAlert
            ...
            {!marketReviewReport && isLoadingReport ? (
              ...
              <div data-testid="home-report-content" className="w-full max-w-none space-y-4 pb-8">
