        ...
        ? createPortal(
            <div className="fixed inset-0 z-[140] flex items-end bg-background/25 backdrop-blur-sm sm:items-center sm:justify-center">
              ...
              <div
                ...
                tabIndex={-1}
                className={cn(
                  'surface-floating relative flex max-h-[88vh] w-full flex-col overflow-hidden rounded-t-[var(--surface-floating-radius)]',
                  'sm:max-w-2xl sm:rounded-[var(--surface-floating-radius)]',
                )}
              >
