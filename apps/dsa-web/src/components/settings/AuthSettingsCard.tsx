  ...
  return (
    ...
    >
      <form className="space-y-4" onSubmit={handleSubmit}>
        <div className="surface-inset settings-border p-4 transition-[background-color,border-color] duration-200 hover:border-[var(--settings-border-strong)] hover:bg-[var(--settings-surface-hover)]">
