...
export const ReportOverview: React.FC<ReportOverviewProps> = ({
  ...
  return (
    <div className="space-y-5">
      {/* 主信息区 - 两列布局 */}
      <div data-testid="report-overview-layout" className="grid grid-cols-1 items-start gap-5 2xl:grid-cols-[minmax(0,1fr)_18rem]">
        {/* 左侧：股票信息与结论 */}
        <div data-testid="report-overview-main" className="min-w-0 space-y-5">
          {/* 股票头部 */}
        ...
        {/* 右侧：情绪指标 / 自选操作 */}
        <div data-testid="report-overview-rail" className="flex min-w-0 flex-col space-y-4">
